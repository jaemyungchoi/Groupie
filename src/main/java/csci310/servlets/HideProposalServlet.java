...
public class HideProposalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            if (proposal == null) {
                ...
                // can't hide if proposal is finalized
                response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                return;
            }

            boolean hide = requestData.getAsJsonObject().get("hide").getAsBoolean();

            proposalDAO.rejectProposal(proposalId, uid, hide);
