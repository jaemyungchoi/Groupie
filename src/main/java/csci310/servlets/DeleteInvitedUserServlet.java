...
public class DeleteInvitedUserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            int invitedUserId = requestData.getAsJsonObject().get("invitedUserId").getAsInt();
            ...
            if (proposal == null) {
                ...
                // can't delete events if proposal is already finalized
                response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                return;
            }

            // do the actual deletion
            if (!proposalDAO.deleteInvitedUser(proposalId, invitedUserId)) {
