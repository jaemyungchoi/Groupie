...
public class AcceptProposalServletTest extends Mockito {
    ...
    static private int testProposalFinalizedId;
    ...
    public static void setUp() throws SQLException {
        ...
        testProposalFinalizedId = realProposalDAO.createProposal(
                testUser.getId(),
                "__TEST__proposal_finalized",
                new String[]{"Z7r9jZ1AdFUqk", "vvG1HZpRndBscg", "G5v0Zpsu6_Nz-"},
                new int[]{testUser2.getId()}
        ).getId();
        realProposalDAO.finalizeProposal(testProposalFinalizedId);
    }
    ...
    public void testInit() {
        AcceptProposalServlet servlet = mock(AcceptProposalServlet.class);
    ...
    public void testDoPost() throws IOException, ServletException {
        ...
        requestData.add("proposalId", new JsonPrimitive(testProposalFinalizedId));
        requestData.add("accept", new JsonPrimitive(true));
        ...
        AcceptProposalServlet servlet = new AcceptProposalServlet();
        ...
        assertEquals(1, deserializedProposal.getAcceptedUsers().length);
        assertEquals(testUser2.getId(), deserializedProposal.getAcceptedUsers()[0].getId());
    }
    ...
    @Test
    public void testDoPostNotFinalized() throws IOException, ServletException {
        HttpServletRequest request = mock(HttpServletRequest.class);
        HttpServletResponse response = mock(HttpServletResponse.class);
        HttpSession session = mock(HttpSession.class);
    ...
    public void testDoPostSQLException() throws IOException, ServletException, SQLException {
        ...
        when(proposalDAO.acceptProposal(anyInt(), anyInt(), anyBoolean())).thenThrow(SQLException.class);
