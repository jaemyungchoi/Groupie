...
public class HideProposalServletTest extends Mockito {
    ...
    public void testInit() {
        HideProposalServlet servlet = mock(HideProposalServlet.class);
    ...
    public void testDoPost() throws IOException, ServletException {
        ...
        requestData.add("hide", new JsonPrimitive(true));
        ...
        HideProposalServlet servlet = new HideProposalServlet();
        ...
        assertEquals(1, deserializedProposal.getHiddenUsers().length);
        assertEquals(testUser2.getId(), deserializedProposal.getHiddenUsers()[0].getId());
    }
