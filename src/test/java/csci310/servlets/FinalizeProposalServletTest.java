...
public class FinalizeProposalServletTest extends Mockito {
    ...
    public void testInit() {
        FinalizeProposalServlet servlet = mock(FinalizeProposalServlet.class);
    ...
    public void testDoPost() throws IOException, ServletException {
        ...
        FinalizeProposalServlet servlet = new FinalizeProposalServlet();
        ...
        assertNotNull(deserializedProposal.getFinalizedEvent());
    }
